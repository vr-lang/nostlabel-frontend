...
export const Footer: React.FC<FooterProps> = ({ 
  ...
  return (
    <footer className="bg-bg-dark-1 text-white/50 pt-24 pb-12 relative overflow-hidden z-10 border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 grid grid-cols-2 md:grid-cols-5 gap-12 text-left mb-20">
        ...
        <div className="space-y-4 col-span-2 md:col-span-2">
          <img
            src="/logo.png"
            alt="NØST"
            className="h-6 w-auto object-contain invert brightness-200 block mb-2"
          />
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-[10px] font-mono tracking-widest uppercase">
        <span className="text-white/30">© 2026 NOSTLABEL. All Rights Reserved.</span>
